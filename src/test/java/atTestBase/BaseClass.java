...
public class BaseClass {
	...
	public void setup(String os, String br) throws Exception {
		...
		//driver.get(p.getProperty("appURL"));//accessing the url from properties file
		driver.get("https://practice.automationtesting.in/");
	}
	
	//next 3 methods are responsible for generating random data for pwd and usernames.
	...
	public String randomAlphaNumeric() {
		...
		return(randomString.toLowerCase()+randomString.toUpperCase()+"@"+randomNumber);
	}
