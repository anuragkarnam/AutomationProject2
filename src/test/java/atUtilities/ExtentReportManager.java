...
public class ExtentReportManager implements ITestListener{
	...
	public void onStart(ITestContext context) {
		...
		sparkReporter.config().setDocumentTitle("AutomationProject2 Automation Report");
		sparkReporter.config().setReportName("AutomationProject2 Functional Testing");
		...
		extent.setSystemInfo("Web-Page", "AT_WebSite");
		extent.setSystemInfo("Module", "Admin");
		extent.setSystemInfo("Sub Module", "Customers");
		extent.setSystemInfo("Browser", "Chrome");
		extent.setSystemInfo("Tester Name", "Anurag Lamba Karnam"/*System.getProperty("user.name")*/);
